...
class RadioButtonGroup extends FormField implements SingleOptionFormFieldInterface
{
    /**
     * @var string|null
     */
    ...
    public function __construct(
        ...
        parent::__construct($formFieldId, $label, FormFieldType::RADIO_BUTTON_GROUP(), $position, $required, $visible);

...
class CheckboxGroup extends FormField implements MultiOptionFormFieldInterface
{
    /**
     * @var string[]
     */
    ...
    public function __construct(
        ...
        parent::__construct($formFieldId, $label, FormFieldType::CHECKBOX_GROUP(), $position, $required, $visible);
